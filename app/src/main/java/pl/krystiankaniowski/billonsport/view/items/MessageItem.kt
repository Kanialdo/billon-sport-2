...
class MessageItem private constructor(val title: String, val description: String) : ViewType {
	...
	companion object {
		...
		fun noData(title: String = "No data", description: String? = null): MessageItem = noData(title, description)

		fun error(title: String = "Error", description: String? = null): MessageItem = noData(title, description)
